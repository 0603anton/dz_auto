...
function Clock() {
    ...
    const start = () => {
        ...
        let timerIdOnStart = setInterval(()=>setDate(new Date(restoreState('hw9-date', Date.now()))),1000);
        setTimerId(Number(timerIdOnStart))
    ...
    // TODO более гибкое использование форматтера, или задавать его под каждый вывод
